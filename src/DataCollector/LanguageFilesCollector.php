...
class LanguageFilesCollector extends AbstractDataCollector implements AssetProvider
{
	...
	{
		return [
			'js' => Uri::root(true) . '/plugins/system/debug4/media/widgets/languageFiles/widget.min.js',
			'css' => Uri::root(true) . '/plugins/system/debug4/media/widgets/languageFiles/widget.min.css',
		];
	}
}
