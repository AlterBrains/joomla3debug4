...
class LanguageStringsCollector extends AbstractDataCollector implements AssetProvider
{
	...
	{
		return [
			'js'  => Uri::root(true) . '/plugins/system/debug4/media/widgets/languageStrings/widget.min.js',
			'css' => Uri::root(true) . '/plugins/system/debug4/media/widgets/languageStrings/widget.min.css',
		];
	}
